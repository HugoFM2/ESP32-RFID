...
class MFRC522:
	...
	def _tocard(self, cmd, send): #mfrc522_Tocard
		...
		#Wreg
		self.cs.value(0)
		self.spi.write(b'%c' % int(0xff & ((0x02 << 1) & 0x7e)))
		self.spi.write(b'%c' % int(0xff & irq_en | 0x80))
		self.cs.value(1)
		#fim Wreg

		#Cflags
		self._cflags(0x04, 0x80) # ClearBitMask // 0x04 = CommIrqReg 
		# # self._wreg(0x04, self._rreg(0x80) | mask)

		# #rreg
		# self.cs.value(0)
		# self.spi.write(b'%c' % int(0xff & (((0x80 << 1) & 0x7e) | 0x80)))
		# val = self.spi.read(1)
		# self.cs.value(1)

		# self.cs.value(0)
		# self.spi.write(b'%c' % int(0xff & ((0x04 << 1) & 0x7e)))
		# self.spi.write(b'%c' % int(0xff & (val[0] & (~0x80) ) ))
		# self.cs.value(1)
		...
		# self.cs.value(0)
		# self.spi.write(b'%c' % int(0xff & ((0x04 << 1) & 0x7e)))
		# # self.spi.write(b'%c' % int(0xff & self._rreg(0x80) | mask))
		# #RREG
		# self.cs.value(0)
	...
	def request(self, mode):
		...
		#WREG
		self.cs.value(0)
		self.spi.write(b'%c' % int(0xff & ((0x0D << 1) & 0x7e)))
		self.spi.write(b'%c' % int(0xff & 0x07))
		self.cs.value(1)
		#wreg
